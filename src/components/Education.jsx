...
const Education = () => {
    return (
        <Container className="education-container">
            <Typography variant="h1" className="education-heading">Understanding the United States Congress</Typography>
            ...
            <Typography variant="h2" className="education-subheading">The Senate</Typography>
            <Typography variant="body1" className="education-text">
            ...
            <Typography variant="h2" className="education-subheading">The House of Representatives</Typography>
            <Typography variant="body1" className="education-text">
            ...
            <Typography variant="h2" className="education-subheading">How Congress Operates</Typography>
            <Typography variant="body1" className="education-text">
