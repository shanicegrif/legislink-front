...
export default function TodayVoteHouse(){
    ...
    useEffect(()=>{
        ...
        axios.get(`https://api.propublica.org/congress/v1/house/votes/${getTodaysDate()}/${getTodaysDate()}.json`, {headers: {
    ...
    */
    return(
        <div style={{ overflow: "auto", maxHeight: "40vh" }}>
                    ...
                    <TableBody>
                        ...
                        >
                            ...
                            <TableCell component="th" scope="row">
                                ...
                                <TableCell align="center">Not Voting:{vote.total.not_voting}</TableCell>
                            </TableCell>
                        </TableRow>
                    )))}
                    </TableBody>
            ...
            ) : (<div>There is no voting in the house today</div>)}
        </div>
   )
}